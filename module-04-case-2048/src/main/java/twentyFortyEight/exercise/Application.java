...
/**
 * This is the application for the 2048 game you have to finish implementing. Have a look around the
 * code and familiarize yourself with the components of it. There are methods in these classes that have
 * no implementation and require to write that implementation.
 *
 * The README.md file contains instructions for you to follow along and eventually complete the 2048 game.
 */
