...
public class HashSetSolution {
    ...
    public static void main(String[] args) {
        ...
        // Answer: you will see only unique names. The duplicates are not added, because they are
        // already in the Set and a Set will only store a maxmimum of _one_ copy of every value.
        System.out.println(names);
        ...
        employees.add(new Employee("Charles"));
        employees.add(new Employee("Sandy"));
        employees.add(new Employee("TheBoss"));

        System.out.println(employees);

        // Now add another Employee with the same name as one you've already added and print the set
        // What do you see? Did you expect to see this?
        employees.add(new Employee("Henk"));
        employees.add(new Employee("Sandy"));
