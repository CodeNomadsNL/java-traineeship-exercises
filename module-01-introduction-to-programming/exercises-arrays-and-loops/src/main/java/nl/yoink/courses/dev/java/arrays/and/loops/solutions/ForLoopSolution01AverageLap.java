...
public class ForLoopSolution01AverageLap {
    ...
    // Write the average lap function here, using a for-loop
    public static int calculateAverageLap(int[] laps, int numberOfLaps) {
        ...
        // Turns out we still need the numberOfLaps, since we still have to divide by that number here
